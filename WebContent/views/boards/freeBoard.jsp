	...
	<div class="container-fluid text-center" style="margin-top:200px">    
		<div class="row content">
			...
			<div class="col-sm-6 text-left"> 
				...
				<h1 style="text-align:center; padding-bottom:40px;">자유 게시판</h1>
				...
				<table class="table table-hover">
					<caption>
						...
						<div class="pull-right">
							...
							<c:if test="${sessionScope.login == null}">
								<input type="button" class="btn btn-default" onclick="window.alert('로그인이 필요합니다')" value="글쓰기"/>
							</c:if>
						</div>
					</caption>
				...
				<div style="text-align: center">
					<nav aria-label="Page navigation">
					 	<ul class="pagination">									
							...
							<c:if test="${pageNum > 1}">
								<li>
									<a href="freeBoard.do?btype=${param.btype}&pageNum=${pageNum-1}" aria-label="Previous">
							        	<span aria-hidden="true">&laquo;</span>
							    	</a>
								</li>
							</c:if>
							...
							<c:forEach var="a" begin="${startpage}" end="${endpage}">
								...
								<c:if test="${a != pageNum}">
									 <li>
									 	<a href="freeBoard.do?btype=${param.btype}&pageNum=${a}">${a}</a>
									 </li>
								</c:if>
							</c:forEach>
							...
							<c:if test="${pageNum < maxpage}">
								<li>
								    <a href="freeBoard.do?btype=${param.btype}&pageNum=${pageNum +1}" aria-label="Next">
								    	<span aria-hidden="true">&raquo;</span>
								    </a>
							    </li>
							</c:if>
